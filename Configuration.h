...
#define PRINTER_NAME "DualEx tarantula)"  // Change this to whatever you wish, or leave it as it is.
 ...
 */
#define E0_STEPS      95.88 // Stock extruder. If you have a Tevo Titan, try 400 then calibrate.
 ...
 * (how to calibrate: https://toms3d.org/2014/04/06/3d-printing-guides-calibrating-your-extruder/)
 */
#define E1_STEPS      95.88 // Stock extruder. If you have a Tevo Titan, try 400 then calibrate
...
#define STRING_CONFIG_H_AUTHOR "(SSK8, DualEx shit)" // Who made the changes.
 ...
 *
 *   #define NOZZLE_TO_PROBE_OFFSET { 10, 10, -0.2 }
 *
 *     +-- BACK ---+
 *     |           |
 *   L |    (+) P  | R <-- probe (20,20)
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { SENSOR_RIGHT - SENSOR_LEFT, SENSOR_BEHIND - SENSOR_FRONT, -0.2 }
